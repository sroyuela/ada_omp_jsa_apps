...
--  It is intended to be used in cases where sequential processing needs to
--  be interleaved with parallel processing, in particular synchronous
--  barriers.
...
generic
package Parallel.Recursion.Pooled_Work_Seeking_Sequential_Interleave is
