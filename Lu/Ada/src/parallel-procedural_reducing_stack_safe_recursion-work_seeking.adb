...
package body Parallel.Procedural_Reducing_Stack_Safe_Recursion.Work_Seeking is
   ...
   is
      ...
      protected type Work_Seeker is
         ...
         procedure Check_Completion (Final_Result : out Result_Type);
      ...
      protected body Work_Seeker is
         ...
         procedure Check_Completion (Final_Result : out Result_Type) is
         begin
            Final_Result := Result;
      ...
      task body Worker is
         ...
         Value : Work_Type;
         Done : Boolean := False;
         Result, Temp : Result_Type := Identity_Value;
         ...
         begin
            return Manager.Storage_Size / 100 *
      ...
      begin -- Worker
         ...
         Work_Loop : loop
            ...
            Process (Value, Stack_Limit, Temp);
      ...
      begin
         ...
         Process (Item, Stack_Limit, Result);
      end Recurse;
   ...
   begin -- Execute_Parallel_Subprogram
      ...
      Scheduler.Check_Completion (Result);
