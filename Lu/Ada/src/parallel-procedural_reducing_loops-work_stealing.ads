...
--  using a work stealing approach and produce a result for an elementary type.

with System.Storage_Elements;
with Ada.Dynamic_Priorities; use Ada;

generic
package Parallel.Procedural_Reducing_Loops.Work_Stealing is

   type Work_Stealing_Manager
...
end Parallel.Procedural_Reducing_Loops.Work_Stealing;
