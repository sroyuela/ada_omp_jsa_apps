...
package body Parallel.Recursion.Pooled_Work_Sharing is
   ...
   is
      ...
      protected body Internal_Work_Manager is
         ...
         entry Wait_For_Completion when Outstanding_Workers = 0 is
         begin
   ...
   begin -- Execute_Parallel_Subprogram
      ...
      Internal_Manager.Wait_For_Completion;

      Manager.Dispatcher := null;

   end Execute_Parallel_Subprogram;

end Parallel.Recursion.Pooled_Work_Sharing;
