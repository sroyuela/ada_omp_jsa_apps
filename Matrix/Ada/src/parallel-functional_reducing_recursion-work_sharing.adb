...
package body Parallel.Functional_Reducing_Recursion.Work_Sharing is
   ...
   is
      ...
      begin -- Worker
         ...
         if not Done then
            ...
            Internal_Manager.Reduce (Process (Value));
         end if;
      ...
      function Recurse
        (Dispatcher : Internal_Dispatcher_Type;
         ...
         Of_Splits  : Recursion_Branch_Count) return Result_Type
      is
   ...
   begin -- Execute_Parallel_Subprogram
      ...
      Internal_Manager.Check_Completion (Result);
...
end Parallel.Functional_Reducing_Recursion.Work_Sharing;
