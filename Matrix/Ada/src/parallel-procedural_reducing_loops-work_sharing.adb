...
package body Parallel.Procedural_Reducing_Loops.Work_Sharing is
   ...
   is
      ...
      begin
         ...
         pragma Warnings (Off, "*Value* modified* but *never referenced");
         ...
         pragma Warnings (On, "*Value* modified* but *never referenced");
...
end Parallel.Procedural_Reducing_Loops.Work_Sharing;
