...
package body Parallel.Functional_Reducing_Stack_Safe_Recursion.Work_Seeking is
   ...
   begin -- Execute_Parallel_Subprogram
      ...
      Scheduler.Check_Completion (Final_Reduction_Value);
...
end Parallel.Functional_Reducing_Stack_Safe_Recursion.Work_Seeking;
