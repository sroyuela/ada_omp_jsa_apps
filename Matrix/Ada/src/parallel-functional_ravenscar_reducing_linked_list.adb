...
package body Parallel.Functional_Ravenscar_Reducing_Linked_List is
   ...
   begin
      ...
      Reduction_Node.Element := Reducer (Item, Reduction_Node.Element);
   ...
   begin
      return Container.Elements (Worker_Count_Type (Position)).Element;
   end Value;
