...
package body Parallel.
  Procedural_Reducing_Stack_Safe_Recursion.Pooled_Work_Seeking is
   ...
   is
      ...
      is
         ...
         function Get_Stack_Limit_Offset
           (Limit : Parallel.Stack_Percentage)
...
end Parallel.Procedural_Reducing_Stack_Safe_Recursion.Pooled_Work_Seeking;
